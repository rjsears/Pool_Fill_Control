...
rachio_url = 'curl -X GET -H "Content-Type: application/json" -H "Authorization: Bearer jhdjhf-8738783473-kfkshfks-9374873487" https://api.rach.io/1/public/device/59f8edckjshkdhsk-7/current_schedule'
